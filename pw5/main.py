import curses
from input import input_box, write_students, write_courses, write_marks
...
class UI:
    ...
    def add_student(self):
        ...
        write_students(self.manager.student)
    ...
    def add_course(self):
        ...
        write_courses(self.manager.course)
        write_marks(self.manager.student)
